...
Candidate spawns are screened by a geometric buffer rule: a placement is
rejected when it lies within 15\,NM of any active aircraft, corresponding
to the 5\,NM separation standard extended by a 10\,NM buffer.
This rule guarantees that no aircraft enters the sector in violation of
separation, and the buffer provides time for the agent to respond before
a newly spawned aircraft can become involved in a conflict.
