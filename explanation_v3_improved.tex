...
Each RL step spans 5\,s (10 BlueSky sub-steps of 0.5\,s); a $45^\circ$ turn takes $\approx40$\,s ($\approx8$ steps), speed changes 2--5 steps.
...
$w_\text{nav}$     & Drift penalty (applied always) & $0.30$ \\
$w_\text{work}$    & Workload & $0.10$ \\
\bottomrule
\end{tabular}
\end{table}
