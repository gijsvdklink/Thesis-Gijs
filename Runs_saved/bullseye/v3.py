...
CONFIG = {
    ...
    'n_aircraft':            lambda: 2,
    'rho':                   lambda: random.uniform(1/60000, 1/40000),  # aircraft/km^2; area = n/rho
                                                                          # -- very large airspace (~80-120k km^2
                                                                          # with n=2): long legs to/from the
                                                                          # central conflict to study drifting
    'sep_nm':                5.0,
    ...
    'w_drift':               1.50,            # accumulates during hold; linear in (1-cos)/2
    ...
    def _compute_reward(self, acting_cs, action_idx):
        ...
        if acting_cs and acting_cs in self._destination_ll:
            ...
            if idx >= 0:
                ...
                # Linear (not squared): keeps the 30/45/60 deg penalties close in
                # magnitude and makes even mild drift expensive enough to fly back.
