"""
v3_ATC_reward — ATCO conflict-resolution environment.
...
CONFIG = {
    ...
    'w_nav':                 0.50,            # drift penalty weight (commanded heading vs destination)
    ...
    def _compute_reward(self, acting_cs, action_idx):
        ...
        if acting_cs and acting_cs in self._destination_ll:
            ...
            if idx >= 0:
                ...
                cos_now = math.cos(math.radians(wrap_to_180(bearing - cmd_hdg)))
